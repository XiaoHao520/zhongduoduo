...
Page({
  ...
  initCategory: function () {
    ...
    a.get("goods/get_category", {}, function (a) {
      t.setData({
        ...
        category_child: [], category_third: [],
        catlevel: a.catlevel, opencategory: a.opencategory
      })
    })
  },
  getList: function () { //t.data.params
    ...
    t.setData({ loading: !0 }),
      ...
      a.get("goods/get_list", t.data.params, function (a) {
        var e = { loading: !1, total: a.total };
        a.list || (a.list = []), a.list.length > 0 && (e.page = t.data.page + 1,
          e.list = t.data.list.concat(a.list),
          a.list.length < a.pagesize && (e.loaded = !0)), t.setData(e)
      })
  },
  changeMode: function () {
    "block" == this.data.listmode ? this.setData({ listmode: "" }) : this.setData({ listmode: "block" })
  },
  bindSort: function (t) {
    var a = t.currentTarget.dataset.order, e = this.data.params; if ("" == a) { if (e.order == a) return; e.order = "", this.setData({ listorder: "" }) } else if ("minprice" == a) this.setData({
      listorder: ""
    }), e.order == a ? "desc" == e.by ? e.by = "asc" : e.by = "desc" : e.by = "asc", e.order = a, this.setData({ listorder: e.by }); else if ("sales" == a) {
      if (e.order == a) return; this.setData({ listorder: "" }), e.order = "sales", e.by = "desc"
    } this.setData({ params: e, page: 1, list: [], loading: !0, loaded: !1, sort_selected: a }),
      this.getList()
  },
  showFilter: function () {
  ...
  btnFilterBtns: function (t) {
    var a = t.target.dataset.type; if (a) {
      var s = this.data.filterBtns; s.hasOwnProperty(a) || (s[a] = ""), s[a] ? delete s[a] : s[a] = 1; var i = e.isEmptyObject(s) ? 0 : 1; this.setData({
        filterBtns: s, isfilter: i
      })
    }
  },
  bindFilterCancel: function () {
    ...
    this.setData({
      page: 1, params: t, isFilterShow: !1, lastcat: "",
  ...
  bindCategoryEvents: function (t) {
    var a = t.target.dataset.id; this.setData({
      lastcat: a
    });
    var e = t.target.dataset.level; 1 == e ? (this.setData({
      category_child: [], category_third: []
    }), this.setData({
      ...
      category_third:
      this.data.allcategory.children[a]
    })) : this.setData({
  ...
  bindInput: function (t) {
    ...
    s.keywords = "", s.order = this.data.params.order,
  ...
  bindnav: function (t) {
    var a = e.trim(t.currentTarget.dataset.text), s = this.data.defaults; s.keywords = a, this.setData({
      params: s, page: 1, fromsearch: !1
    }), this.getList(), this.setRecord(a)
  },
  getRecord: function () {
    var a = t.getCache("searchRecords"); this.setData({
      searchRecords: a
    })
  },
  setRecord: function (a) {
    if ("" != a) {
      var s = t.getCache("searchRecords"); if (e.isArray(s)) {
        var i = []; i.push(a); for (var r in s) {
